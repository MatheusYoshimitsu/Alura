...
class ProgramaSerializerTestCase(TestCase):
    ...
    def test_verifica_campos_serializados(self): # Teste de unidade
    ...
    def test_verifica_conteudo_dos_campos_serializados(self): # Teste de unidade
        ...
        # nao temos o dislikes sendo serializado, entao nao faz sentido coloca-lo aqui
